            ...
            <div class="center">
                ...
                <nav id="menu">
                    <ul>
                        ...
                        <li>
                            <router-link :to="{name:'pagina',params:{id:'TU MAMA ME MIMA'}}" active-class="active">Pagina 1</router-link>
                        </li>
                        <li>
                           <router-link to="/series" active-class="active">Series</router-link>
                        </li>                            
                    </ul>
                </nav>
